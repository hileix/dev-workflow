        ...
        >
          ...
          >
            ...
            <textarea
              ...
              className="flex min-h-[420px] w-full resize-y rounded-xl border border-input bg-card/70 px-4 py-3 font-mono text-sm text-foreground outline-none placeholder:text-muted-foreground focus:border-ring"
              rows={18}
            />
